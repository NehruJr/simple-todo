...
class Todos extends Model {
  ...
  const Todos._internal({required this.id, required tasks, isDone, createdAt, updatedAt}): _tasks = tasks, _isDone = isDone, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Todos({String? id, required String tasks, bool? isDone}) {
  ...
  Todos copyWith({String? id, String? tasks, bool? isDone}) {
    return Todos._internal(
      id: id ?? this.id,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'tasks': _tasks, 'isDone': _isDone, 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };

  static final QueryField ID = QueryField(fieldName: "todos.id");
  static final QueryField TASKS = QueryField(fieldName: "tasks");
